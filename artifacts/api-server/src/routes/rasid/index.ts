...
import { getCredentials, clearCredentialCache } from "../../lib/authStore";
...
async function proxy(
  ...
  if (!creds) {
    res.status(401).json({ success: false, error: "No credentials configured. Please save your DTTS username and password first.", rawXml: null, notificationId: null });
    return;
  }
...
router.post("/auth/config", async (req, res): Promise<void> => {
  ...
  const existing = await db.select().from(authConfigTable).limit(1);
  if (existing.length > 0) {
    await db.update(authConfigTable).set({ username, passwordEncrypted: password, baseUrl: baseUrl || "https://tandttest.sfda.gov.sa", updatedAt: new Date() });
  } else {
    await db.insert(authConfigTable).values({ username, passwordEncrypted: password, baseUrl: baseUrl || "https://tandttest.sfda.gov.sa" });
  }

  clearCredentialCache();
  res.json({ username, hasPassword: true, baseUrl });
});
...
router.post("/rasid/import", async (req, res): Promise<void> => {
  ...
  await proxy("Import", svcUrl("ImportService"), body, req.body, res);
});
...
router.post("/rasid/import-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("ImportCancel", svcUrl("ImportCancelService"), body, req.body, res);
});
...
router.post("/rasid/supply", async (req, res): Promise<void> => {
  ...
  await proxy("Supply", svcUrl("SupplyService"), body, req.body, res);
});
...
router.post("/rasid/supply-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("SupplyCancel", svcUrl("SupplyCancelService"), body, req.body, res);
});
...
router.post("/rasid/dispatch", async (req, res): Promise<void> => {
  ...
  await proxy("Dispatch", svcUrl("DispatchService"), body, req.body, res);
});
...
router.post("/rasid/dispatch-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("DispatchCancel", svcUrl("DispatchCancelService"), body, req.body, res);
});
...
router.post("/rasid/accept", async (req, res): Promise<void> => {
  ...
  await proxy("Accept", svcUrl("AcceptService"), body, req.body, res);
});
...
router.post("/rasid/accept-dispatch", async (req, res): Promise<void> => {
  ...
  await proxy("AcceptDispatch", svcUrl("AcceptDispatchService"), body, req.body, res);
});
...
router.post("/rasid/return", async (req, res): Promise<void> => {
  ...
  await proxy("Return", svcUrl("ReturnService"), body, req.body, res);
});
...
router.post("/rasid/consume", async (req, res): Promise<void> => {
  ...
  await proxy("Consume", svcUrl("ConsumeService"), body, req.body, res);
});
...
router.post("/rasid/consume-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("ConsumeCancel", svcUrl("ConsumeCancelService"), body, req.body, res);
});
...
router.post("/rasid/transfer", async (req, res): Promise<void> => {
  ...
  await proxy("Transfer", svcUrl("TransferService"), body, req.body, res);
});
...
router.post("/rasid/transfer-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("TransferCancel", svcUrl("TransferCancelService"), body, req.body, res);
});
...
router.post("/rasid/pharmacy-sale", async (req, res): Promise<void> => {
  ...
  await proxy("PharmacySale", svcUrl("PharmacySaleService"), body, req.body, res);
});
...
router.post("/rasid/pharmacy-sale-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("PharmacySaleCancel", svcUrl("PharmacySaleCancelService"), body, req.body, res);
});
...
router.post("/rasid/deactivation", async (req, res): Promise<void> => {
  ...
  await proxy("Deactivation", svcUrl("DeactivationService"), body, req.body, res);
});
...
router.post("/rasid/deactivation-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("DeactivationCancel", svcUrl("DeactivationCancelService"), body, req.body, res);
});
...
router.post("/rasid/export", async (req, res): Promise<void> => {
  ...
  await proxy("Export", svcUrl("ExportService"), body, req.body, res);
});
...
router.post("/rasid/export-cancel", async (req, res): Promise<void> => {
  ...
  await proxy("ExportCancel", svcUrl("ExportCancelService"), body, req.body, res);
});
...
router.post("/rasid/package-upload", async (req, res): Promise<void> => {
  ...
  await proxy("PackageUpload", svcUrl("PackageUploadService"), body, req.body, res);
});
...
router.post("/rasid/package-download", async (req, res): Promise<void> => {
  ...
  await proxy("PackageDownload", svcUrl("PackageDownloadService"), body, req.body, res);
});
...
router.post("/rasid/package-query", async (req, res): Promise<void> => {
  ...
  await proxy("PackageQuery", svcUrl("PackageQueryService"), body, req.body, res);
});
...
router.post("/rasid/check-status", async (req, res): Promise<void> => {
  ...
  await proxy("CheckStatus", svcUrl("CheckStatusService"), body, req.body, res);
});
...
router.post("/rasid/dispatch-detail", async (req, res): Promise<void> => {
  ...
  await proxy("DispatchDetail", svcUrl("DispatchDetailService"), body, req.body, res);
});
...
router.post("/rasid/country-list", async (req, res): Promise<void> => {
  ...
  await proxy("CountryList", svcUrl("CountryListService"), body, {}, res);
});
...
router.post("/rasid/city-list", async (req, res): Promise<void> => {
  ...
  await proxy("CityList", svcUrl("CityListService"), body, {}, res);
});
...
router.post("/rasid/drug-list", async (req, res): Promise<void> => {
  ...
  await proxy("DrugList", svcUrl("DrugListService"), body, req.body ?? {}, res);
});
...
router.post("/rasid/error-code-list", async (req, res): Promise<void> => {
  ...
  await proxy("ErrorCodeList", svcUrl("ErrorCodeListService"), body, {}, res);
});
...
router.post("/rasid/stakeholder-list", async (req, res): Promise<void> => {
  ...
  await proxy("StakeholderList", svcUrl("StakeholderListService"), body, req.body ?? {}, res);
});
